 ...
 * env::PlatformThread class, such as starting a thread from a non-static class
...
/**
 * Creates a env::PlatformThread that runs a given function with arguments
 * @param Ret return type of `fn`
 * @param Args types of arguments to `fn`
 * @param fn the target function
 * @param args the arguments to `fn`
 * @return env::PlmThreadatfor that is running `fn`
 */
template <typename Ret, typename... Args>
env::PlatformThread make_thread(Ret (*fn)(Args...), Args... args) {
	...
	env::PlatformThread internal_thread = env::PlatformThread(internal::wrap_func_<decltype(fn), Args...>, (void*)func_and_args);
...
/**
 * Creates a env::PlatformThread that runs a member function with arguments
 * @tparam Cls type of `cls_instance`
 ...
 * @param cls_fn pointer to function callable from `cls_instance`; i.e., `&Cls::some_function`
 * @param args arguments to `cls_fn`
 * @return env::PlatformThread that is running `cls_fn`
 */
template <typename Cls, typename Ret, typename... Args>
env::PlatformThread make_member_thread(Cls* cls_instance, Ret (Cls::*cls_fn)(Args...), Args... args) {
